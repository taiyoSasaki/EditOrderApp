...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        createButton.setOnClickListener { v ->
            ...
            //アカウント作成時は店舗名を入力してもらう
            showNameInputDialog(v)
    ...
    private fun showNameInputDialog(v :View) {
        // ダイアログ専用のレイアウトを読み込む
        ...
        editText.hint = getString(R.string.store_name_input_hint)

        val dialog = AlertDialog.Builder(this)
            .setTitle(getString(R.string.store_name_input_title))
        ...
        editText.addTextChangedListener( object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                // 1~15文字の時だけOKボタンを有効化する
                if (s.isNullOrEmpty() || s.length > 15) {
